...
Furthermore, I remember I was browsing on my phone at that time, and for applying I created an account on their platform somewhere, but at that time didn't upload my Resume as it was lacking some updates, and with the holidays preparations and everything I forgot to add it later as I intended.
...
In my opinion the ad described me perfectly. The only thing specified in the ad, that's missing from my tool belt: _Python with Django Framework_ for the backend, but that was mention in the "nice to have" list.
However, as I have failed to provide them my resume, how would this company possibly know about my strengths and weaknesses?
...
-   showcase the relevant skills here, better that I could do it in a resume. Those were:
...
So, while not the best showcase for my front-end skills 🤓 _yet_, building this website might offer some view about my relevant skills and capabilities, but is there enough time to go through what it means to build a backend in `Django`?
