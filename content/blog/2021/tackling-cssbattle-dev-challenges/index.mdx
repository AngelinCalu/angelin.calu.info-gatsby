...
The first challenge (the one in the top-left corner) was done by more than 100 people with only 54 characters of code. I managed to do it with 80.
...
I'll build here a code minifier which I'm planning to use on the CSSBattle website, to save me from doing a lot of things manually.
