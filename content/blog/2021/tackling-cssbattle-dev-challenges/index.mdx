...
<Callout>
    I'm planning to keep this post updated with my progress on the website. Last update: <b>26.01.2021</b>
</Callout>
...
My current global rank (as of today 26.01.2021) is 291st out of 47615. Hopefully I will be able to find some time to compete and climb up the ladder.

Some other useful tricks I've read about:

-   instead of `rotate(180deg)` in transforms, use `scaleY(-1)`
