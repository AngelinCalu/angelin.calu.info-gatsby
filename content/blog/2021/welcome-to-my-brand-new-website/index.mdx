...
And, the biggest challenge, probably, will be to build a solid portfolio. For that I'm also considering the idea of creating some live screencasts, but not without having some audience.
So, make sure you check back in regularily, if you want to see those new features or other updates.
