        ...
        <section className="space-y-2 flex flex-col-reverse md:flex-row">
            <div className="px-6 space-y-3">
                ...
                <p className="indent">
                    ...
                    passionate about technology in general, started coding years before Stackoverflow launched (<i>I'm
                    referring to a certain period when developers used <span>&lt;table&gt;</span> elements to define the
                    layout for a web page and combining PHP and HTML in same file was the standard. Grose, I know!</i>).
                </p>
                <p className="indent">
                ...
                <p className="indent">Please feel free to browse around, and don't hesitate to reach out, for whatever reason.</p>
            </div>
